...
Revision ID: 24f16e05d63a
Revises: 
Create Date: 2023-03-11 14:48:15.723004
...
def upgrade():
    ...
    sa.Column('target_sets_count', sa.Integer(), nullable=False),
    sa.Column('target_reps_count', sa.Integer(), nullable=False),
    ...
    sa.Column('exercise_id', sa.Integer(), nullable=False),
    sa.Column('instructions', sa.String(length=10000), nullable=True),
    sa.Column('target_reps_count', sa.Integer(), nullable=True),
    sa.Column('target_sets_count', sa.Integer(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('workout_session_step_id', sa.Integer(), nullable=False),
    sa.Column('actual_reps_count', sa.Integer(), nullable=True),
    sa.Column('actual_weight', sa.Float(), nullable=True),
    sa.Column('creator_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['workout_session_step_id'], ['workout_session_steps.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
